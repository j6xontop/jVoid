...
window.open(discord);
function closemenu() {
  alert("The menu has been removed. Click the book mark again to enable VoidV1.");
  document.getElementById("VoidV1").remove();
...
// Create a new copyright element to replace the existing one
const newCopyrightElement = document.createElement("p");
newCopyrightElement.innerHTML = "© " + new Date().getFullYear() + " Void. All Rights Reserved.";

// Replace the old copyright element with the new one
copyrightElement.innerHTML = "";
copyrightElement.appendChild(newCopyrightElement);
